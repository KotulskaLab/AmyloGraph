...
We contacted 125 authors and out of the XYZ responded and confirmed XYZ interactions in XYZ manuscripts.
...
lapply(1L:nrow(all_refs), function(ith_ref_id) {
  cat(all_refs[ith_ref_id, "all_names"], ", **", all_refs[ith_ref_id, "title"], "**, ", all_refs[ith_ref_id, "journal"], ", ", all_refs[ith_ref_id, "year"], "\n\n")
})
```
