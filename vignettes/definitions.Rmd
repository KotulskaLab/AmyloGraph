...
We contacted 122 authors. 11 authors confirmed 81 interactions (`r 81/total_number_int` %) in 21 manuscripts (`r 21/total_number_pubs` %). Despite our efforts, we could not find a way to contact the authors of 3 manuscripts.
